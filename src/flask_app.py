...
def flaskInit():
    ...
    def browseRecommendations():
        ...
        database_global_var.playlists = playlist_query.fetchall()
        database.commitAndCloseDatabaseConnection(db_connection, cursor)
        return render_template("browse_recommendations.html", playlists = database_global_var.playlists, user_info = login_global_var.user_info)
    ...
    def browseTracks():
        ...
        database_global_var.tracks = tracks_query.fetchall()
        database.commitAndCloseDatabaseConnection(db_connection, cursor)
        return render_template('browse_tracks.html', tracks=database_global_var.tracks, user_info = login_global_var.user_info)
    ...
    def singleGenerate():
        ...
        database_global_var.correlation = correlation
        database_global_var.generation_method = "single"
        database_global_var.parameters = track
        database_global_var.ai = True
    ...
    def singleNoAiGenerate():
        ...
        database_global_var.generation_method = "singleNoAi"
        database_global_var.parameters = track
        database_global_var.ai = False
    ...
    def vectorGenerate():
        ...
        if vector is not None:
            ...
            database_global_var.correlation = correlation
            database_global_var.generation_method = "vector"
            database_global_var.parameters = database.vectorToString(vector)
            database_global_var.ai = True
    ...
    def vectorNoAiGenerate():
        ...
        if vector is not None:
            ...
            database_global_var.generation_method = "vectorNoAi"
            database_global_var.parameters = database.vectorToString(vector)
            database_global_var.ai = False
    ...
    def barGenerate():
        ...
        database_global_var.generation_method = "bar"
        database_global_var.parameters = database.vectorToString(parameters)
    ...
    def barNoAiGenerate():
        ...
        database_global_var.generation_method = "barNoAi"
        database_global_var.parameters = parameters
        database_global_var.ai = False
    ...
    def historyGenerate():
        ...
        database_global_var.correlation = correlation
        database_global_var.generation_method = "history"
        database_global_var.ai = True
    ...
    def historyNoAiGenerate():
        ...
        recommendations_data = recommendations.to_dict(orient='records')
        session['recommendations'] = recommendations_data
        database_global_var.generation_method = "historyNoAi"
        database_global_var.ai = False
        return render_template("user_generate.html", recommendations = recommendations, user_info = login_global_var.user_info)
    ...
    def favouritesGenerate():
        ...
        database_global_var.correlation = correlation
        database_global_var.generation_method = "favourites"
        database_global_var.ai = True
    ...
    def favouritesNoAiGenerate():
        ...
        recommendations_data = recommendations.to_dict(orient='records')
        session['recommendations'] = recommendations_data
        database_global_var.generation_method = "favouritesNoAi"
        database_global_var.ai = False
        return render_template("user_generate.html", recommendations = recommendations, user_info = login_global_var.user_info)
    ...
    def uploadToAccount():
        ...
        if database_global_var.ai==True:
            database.addPlaylistToDatabase(playlist_name, database_global_var.generation_method, database_global_var.parameters)
            for index, track_uri in enumerate(track_uris):
                database.addTrackToDatabase(None, index+1, track_uri, int(database_global_var.recommended_indices[index]), recommendations.iloc[index]['Track'], recommendations.iloc[index]['Artist'], recommendations.iloc[index]['Album'])
